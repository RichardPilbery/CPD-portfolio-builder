...
<header class="flex flex-wrap items-center mb-3 py-2">
        @if($profile == 0)
        <p class="w-full text-gray-500"><a href="/home">Home</a> / <a href="/portfolio">Portfolio</a> / Edit Your Summary of Practice</p>
        <div class="flex justify-between items-center w-full">
            <h2>Edit Your Summary of Practice</h2>
        </div>
    @else
        <p class="w-full text-gray-500"><a href="/home">Home</a> / <a href="/user/1/edit">Step 1</a> / Step 2</p>
        <div class="flex justify-between items-center w-full">
            <h2><i class="fas fa-paperclip"></i> Step 2: Edit Your Summary of Practice</h2>
        </div>
    @endif
</header>
...
{{--     <ul>
    ...
    <div class="w-full sm:w-3/4 md:w-3/4 lg:w-3/4 px-2">
        ...
        <form method="POST" action="/summary/{{$summary->id}}">
            ...
            <p class="pb-10">For HCPC audits, there is a word limit of 500 words.</p>
            ...
            <div class="word_count_component"
                data-text="{{ old('work_details', $summary->work_details) }}"
            ...
            <div class="word_count_component"
                data-text="{{ old('service_users', $summary->service_users) }}"
            ...
            <div class="word_count_component"
                data-text="{{ old('job_description', $summary->job_description) }}"
            ...
            <div class="word_count_component"
                data-text="{{ old('standard1', $summary->standard1) }}"
            ...
            <div class="word_count_component"
                data-text="{{ old('standard2', $summary->standard2) }}"
